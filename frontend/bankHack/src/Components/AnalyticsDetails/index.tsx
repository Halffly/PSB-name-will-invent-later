  ...
  React.useEffect(() => {
    (async () => {
      ...
      analytics &&
        setPrototypeData({
          Data: {
            title: "ПСБ кабинет. Тест историй главного экрана",
            description:
              "Большой блок карточек, расположенный на главном экране под кнопками управления аккаунтом. Задействует сервис, генерирующий карты.",
            views: 20,
            rate: 4.3,
            imageUrl:
