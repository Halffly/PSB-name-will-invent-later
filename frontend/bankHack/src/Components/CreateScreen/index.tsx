        ...
        <Grid container spacing={4}>
          ...
          <Grid item md={7} xs={12}>
            <Box textAlign="left" marginTop={3}>
              <FilledTextInput
                placeholder="ПСБ кабинет. Тест историй главного экрана"
                variant="filled"
                fullWidth
                label="Название"
                InputLabelProps={{
            ...
            <Box textAlign="left" marginTop={3}>
              <FilledTextInput
                placeholder="Большой блок карточек, расположенный на главном экране под кнопками управления аккаунтом. Задействует сервис, генерирующий карты."
                multiline
                variant="filled"
                fullWidth
